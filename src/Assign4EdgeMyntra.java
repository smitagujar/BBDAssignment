...
public class Assign4EdgeMyntra {
	...
	public static void main(String[] args) throws InterruptedException {
	 ...
	 //	C1.findElement(By.xpath("//a[@href='/shop/men']")).click();
	 
	 	System.out.println ("After");
		
	 	
		
		//WebElement TShirtTab =C1.findElement(By.xpath("//a[@href='/men-tshirts']"));
		//WebElement Web1 =  C1.findElement(By.xpath("//*[@id=\"desktop-header-cnt\"]/div[2]/nav/div/div[1]/div/div/div/div/li[1]/ul/li[3]/a"));
		//WebElement Web2 =  C1.findElement(By.xpath("//*[@id=\"desktop-header-cnt\"]/div[2]/nav/div/div[1]/div/div/div/div/li[1]/ul/li[3]"));
	
		 
		// System.out.println("link: " + Web1.getText());

	   //    act.moveToElement(Web1).click();
	   //    act.moveToElement(Web2).click();
			    	...
			    	List <WebElement> Products = C1.findElements(By.cssSelector("[class='common-customCheckbox vertical-filters-label']"));
				      ...
				      */
						...
						//    C1.findElement(By.xpath("//p[contains(text(),'Enter Optionality']")).click();
						    ...
						    //WebElement Bag = C1.findElement(By.xpath("//*[contains(@class,'pdp-action-container pdp-fixed')]"));  
							 //Bag.click();
							 
							 
						//	 WebElement Cart = C1.findElement(By.xpath("//*[@class='myntraweb-sprite desktop-iconBag sprites-headerBag']"));
						//	 Cart.click();
							// G1.findElement(By.linkText("Bag")).click();
							...
							// WebElement Wish = C1.findElement(By.xpath("//*[@class='inlinebuttonV2-base-actionButton itemContainer-base-inlineButton  wishlistButton']"));
							 // myntraweb-sprite desktop-iconBag sprites-headerBag
							 //System.out.println("Wish Text :" +  Wish.getText());
					    	// Wish.click();
