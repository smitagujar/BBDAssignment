...
public class Assign4FireFoxMyntra {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebDriver C1 = new FirefoxDriver(options);
	   ...
	   System.out.println ("Before");
		...
		WebElement MenTab =C1.findElement(By.xpath("//*[@id='desktop-header-cnt']/div[2]/nav/div/div[1]/div/a"));
		//WebElement MenTab =C1.findElement(By.xpath("//a[@class='desktop-main'][normalize-space()='Men']"));
		
		System.out.println("MenTab"+ MenTab.getText());
		...
		//WebElement Sweater  = C1.findElement(By.xpath("//a[normalize-space()='Sweaters']"));
		WebElement Sweater = C1.findElement(By.xpath("//*[@id=\"desktop-header-cnt\"]/div[2]/nav/div/div[1]/div/div/div/div/li[1]/ul/li[6]/a"));
	    
		System.out.println("Sweater Descr: "+ Sweater.getText());
	
	     
	    //Actions act1 =new Actions(C1);
	  // act1.moveToElement(Sweater).build().perform();
			    	...
			    	List <WebElement> Products = C1.findElements(By.cssSelector("[class='common-customCheckbox vertical-filters-label']"));
				      ...
				      */
				    	...
				    	List <WebElement> Prod = C1.findElements(By.cssSelector("[class='product-imageSliderContainer']"));
						 System.out.println("Price List Count is :" + Prod.size() );
						 for(int i= 0; i < Prod.size(); i++ )
						 	{
						 		System.out.println("Price :" +  Prod.get(i).getText());
						 		Thread.sleep(2000);
